...
- 정보를 얻기 위한 합리적인 확인 질문(예: "언제 요청하셨나요?", "어떤 상황에서 발생했나요?", 발생 시점·상황 구체화 질문)은 지침이 권장하는 '확인 질문 품질'의 핵심이며 가점 요소입니다. 이런 질문을 "고객이 부담스러울 수 있다"는 식으로 약점·리스크로 지적하지 마세요. 절대 흠으로 보면 안 됩니다.
...
[약점·리스크]
- 실제로 응대 품질을 떨어뜨린 명확한 문제만 근거와 함께 적으세요. 좋은 응대(특히 정당한 확인 질문)를 억지로 흠잡지 마세요. 뚜렷한 약점이 없으면 "특별한 약점 없음"이라고 적으세요.
