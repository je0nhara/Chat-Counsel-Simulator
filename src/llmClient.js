...
5. 유형성(Tangibles) / 문장 구성·가독성·표현 품질 (20점): 문장이 정돈되고 자연스러우며 고급스러운가. 단순히 문단을 나눴다고 고점을 주지 마세요. 어색한 비문, 피동 오용("~로 보여집니다"), 부자연스럽게 압축된 표현("~가능점", "진행도움드릴까요" 같은 비문), 딱딱한 정보 나열이 있으면 감점하고, 정말 매끄럽고 전문적인 문장일 때만 고점을 주세요.
...
- 고객이 '원인 → 해결 → 절차'처럼 단계적으로 추가 질문을 이어가는 것은 지극히 자연스러운 대화 흐름입니다. 상담사가 각 질문에 적절히 답했다면 오히려 좋은 응대이니, "설명이 간략해서 고객이 추가 질문을 했다"는 식으로 약점 삼지 마세요.
- 점수는 후하게 주되 변별력 있게: 안정적으로 응대해 상담을 잘 마무리했다면 80점대를 기본으로 보고, 90점 이상(A)은 문제 해결·공감·문장 표현이 거의 흠잡을 데 없이 우수할 때만 주세요. 흐름은 좋아도 문장이 어색하거나 공감이 약하면 80점대가 적절합니다.
- 각 항목의 근거는 서로 다른 실제 발화를 인용해 구체적으로 쓰세요. 똑같은 문장을 여러 항목에 복사해 넣지 마세요.
